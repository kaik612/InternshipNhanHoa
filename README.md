...
- Phần mềm quản lý doanh nghiệp: các giải pháp phần mềm quản lý doanh nghiệp, như CRM, ERP.
...
2.2 Quy trình hoạt động của Hosting
...
8.2 Các ưu điểm nổi bật của Nginx
...
Chức năng chính: Kerio Connect cung cấp dịch vụ email, lịch chia sẻ, danh bạ, quản lý tác vụ, và chức năng chat (IM) trong một giải pháp tích hợp duy nhất.
...
- Bảo mật: SSH mã hóa tất cả dữ liệu truyền đi giữa máy tính của bạn và máy chủ từ xa, giúp bảo vệ thông tin nhạy cảm như mật khẩu khỏi bị đánh cắp.
...
- Ứng dụng (Application)
	...
	+ UDP: thường sử dụng cho các ứng dụng yêu cầu tốc độ cao, hoặc có thể chấp 	nhận mất gói dữ liệu, như streaming video, VoIP, trò chơi trực tuyến, DNS
...
- Cách hoạt động của định tuyến tĩnh
	...
	+ Bảng định tuyến: mỗi bộ định tuyến trong mạng sẽ duy trì 1 bảng định tuyến, 	trong đó chứa thông tin về các mạng nó có thể kết nối đến và đường đi nào cần 	chọn để chuyển tiếp gói tin đến các mạng đó
	+ Không thay đổi tự động: vì các đường dẫn trong định tuyến tĩnh được cấu hình 	thủ công, chúng không tự động thay đổi khi có sự cố xảy ra (như khi 1 tuyến mạng 	bị lỗi). Điều này có nghĩa là nếu 1 tuyến đường bị gián đoạn, quản trị viên mạng 	phải can thiệp và thay đổi cấu hình để thiết lập lại đường dẫn khác
- Ưu điểm của định tuyến tĩnh
	+ Đơn giản: việc cấu hình và quản lý định tuyến tĩnh rất đơn giản đói với các mạng 	nhỏ hoặc những nơi mà cấu trucs mạng ít thay đổi.
	+ Bảo mật: do các đường dẫn được cấu hình thủ công, nó ít bị ảnh hưởng bởi các 	cuộc tấn công từ bên ngoài, VD như tấn công từ chối dịch vụ (DoS)
	+ Hiệu suất cao: định tuyến tĩnh không yêu cầu bộ định tuyến phải trao đổi thông 	tin đinh tuyến với các bộ định tuyến khác, giúp tiết kiệm tài nguyên và tăng hiệu 	suất
- Nhược điểm
	+ Không linh hoạt: định tuyến tĩnh không tự động thích ứng với các thay đổi trong 	mạng. Nếu có sự thay đổi xảy ra, cần phải cập nhật thủ công bằng bảng định tuyến
	+ Khó quản lý: đối với mạng lớn hoặc phức tạp, việc cấu hình và bảo trì định tuyến 	tĩnh trở nên khó khăn và tốn thời gian 
...
- Địa chỉ IP riêng và công cộng
	...
	- Public IP: được sử dụng để nhận diện thiết bị trên Internet. Địa chỉ này là duy 	nhất trên toàn thế giới
- Quá trình NAT diễn ra như sau
	+ B1: Khi 1 thiết bị trong mạng nội bộ (có địa chỉ IP riêng) muốn gửi dữ liệu ra 	ngoài Internet, nó sẽ gửi gói tin tới router (hoặc thiết bị NAT)
...
- Static NAT
	...
	+ Ít được sử dụng do tốn nhiều địa chỉ IP công cộng
- Dynamic NAT
	+ Mỗi địa chỉ IP riêng có thể được ánh xạ với 1 địa chỉ IP công cộng ngẫu nhiên từ 	1 nhóm địa chỉ IP công cộng được cấu hình sẵn
	+ Nếu không có đủ IP công cộng, thiết bị có thể phải chờ
...
- Ưu điểm:
	...
	+ Tăng cường bảo mật, vì các thiết bị nội bộ không lộ địa chỉ IP thật ra ngoài 	Internet
- Nhược điểm
	+ Có thể gây trễ do quá trình chuyển đổi địa chỉ IP
	+ 1 số ứng dụng yêu cầu truyền thông trực tiếp (như VoIP, VPN) có thể gặp khó 	khăn khi sử dụng NAT
